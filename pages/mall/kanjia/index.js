...
Page({
  ...
  onShareAppMessage: function() {
    ...
    return {
      title: "帮我来砍价",
      path: "/pages/mall/kanjia/index?kjId=" + that.data.kjId + "&joiner=" + that.data.joiner + "&id=" + that.data.id,
      success: function(res) {
        // 转发成功
      },
      fail: function(res) {
  ...
  tobuy: function() {
    wx.navigateTo({
      url: "/pages/mall/goods-details/index?id=" + this.data.kanjiaInfo.kanjiaInfo.goodsId + "&kjId=" + this.data.kanjiaInfo.kanjiaInfo.kjId
    })
  }
})