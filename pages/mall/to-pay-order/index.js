...
Page({
    ...
    wx.request({
      ...
      success: (res) => {
        ...
        app.sendTempleMsg(res.data.data.id, -1,
          ...
          'pages/mall/index/index', JSON.stringify(postJsonString));
        postJsonString = {};
        postJsonString.keyword1 = {
          value: '您的订单已发货，请注意查收',
          color: '#173177'
        ...
        app.sendTempleMsg(res.data.data.id, 2,
          ...
          'pages/mall/order-details/index?id=' + res.data.data.id, JSON.stringify(postJsonString));
        // 下单成功，跳转到订单管理界面
        wx.redirectTo({
  ...
  addAddress: function() {
    wx.navigateTo({
      url: "/pages/mall/address-add/index"
    })
  },
  selectAddress: function() {
    wx.navigateTo({
      url: "/pages/mall/select-address/index"
    })
  },
