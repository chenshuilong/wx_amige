...
Page({
  ...
  wuliuDetailsTap: function(e) {
    ...
    wx.navigateTo({
      url: "/pages/mall/wuliu/index?id=" + orderId
    })
  },
            ...
            success: (res) => {
              if (res.data.code == 0) {
                ...
                app.sendTempleMsgImmediately('uJL7D8ZWZfO29Blfq34YbuKitusY6QXxJHMuhQm_lco', formId,
                  '/pages/mall/order-details/index?id=' + orderId, JSON.stringify(postJsonString));
              }
            }
          })
        }
    ...
    wx.request({
      ...
      success: (res) => {
        ...
        if (res.data.code == 0) {
          ...
          app.sendTempleMsgImmediately('uJL7D8ZWZfO29Blfq34YbuKitusY6QXxJHMuhQm_lco', formId,
            '/pages/mall/order-details/index?id=' + that.data.orderId, JSON.stringify(postJsonString));
        }
      }
    })
  }
